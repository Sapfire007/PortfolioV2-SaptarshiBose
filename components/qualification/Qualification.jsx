          ...
          >
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              <div>
                ...
                <span className="qualification__subtitle">Vellore Institute of Technology - Andhra Pradesh</span>
                <div className="qualification__calender">
                  <i className="uil uil-calendar-alt"></i> 2024 - 2028
                </div>
              </div>
            ...
            <motion.div className="qualification__data" variants={dataVariants}>
              ...
              <div>
                ...
                <span className="qualification__subtitle">Modern Public School (ICSE) - West Bengal</span>
                <div className="qualification__calender">
