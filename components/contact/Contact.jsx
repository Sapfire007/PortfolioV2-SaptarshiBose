                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">sapfire955@gmail.com</span>

                            <a href="mailto:sapfire955@gmail.com" className="contact__button">Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">(+91) 9330097490</span>

                            <a href="https://api.whatsapp.com/send?phone=9330097490&text=Hello, I would like to connect with you!" className="contact__button">Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
                    </div>
                </div>
            ...
            {showPopup && (
                <div className="contact__popup">
                    <div className="contact__popup-content">
                        <i className="uil uil-check-circle contact__popup-icon"></i>
                        <h3 className="contact__popup-title">Thank you for your message!</h3>
                        <p className="contact__popup-text">I will get back to you as soon as possible.</p>
                    </div>
                </div>
            )}
        </section>
