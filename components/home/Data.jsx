...
const Data = () => {
  ...
  const originalText = "Saptarshi Bose";
  ...
  return (
    <div className="home__data">
      ...
      <h3 className="home__subtitle">Front-end dev & ML engineer</h3>
      <p className="home__description">I'm a creative and dedicated developer with a strong passion for technology and innovation.</p>
